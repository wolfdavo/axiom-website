  ...
  return (
    <div className="App">
      ...
      <div className="App-body">
        ...
        <p>When you are accepted into Axiom, you are being welcomed into an ever-expanding and carefully selected network of exceptional people. You have a direct line to everyone in the syndicate. We do everything we can to support each other, creating a powerful network that you can leverage to do great things.</p>
